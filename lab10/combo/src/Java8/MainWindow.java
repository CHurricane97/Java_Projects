...
public class MainWindow extends JFrame {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "Java: 8");
	...
	public MainWindow() {
		...
		encryptButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				case "Algorytm RSA":
					try {
						String kname=JOptionPane.showInputDialog("Podaj nazwe klucza");
						RSAPublicKey pu = (RSAPublicKey) manager.ks.getCertificate(kname).getPublicKey();
						RSAPrivateKey pr = (RSAPrivateKey) manager.ks.getKey(kname, JOptionPane.showInputDialog("Enter password").toCharArray());
				...
				case "Algorytm AES":
					try {
						SecretKey sc = (SecretKey) manager.ks.getKey(JOptionPane.showInputDialog("Podaj nazwe klucza"),JOptionPane.showInputDialog("Enter password").toCharArray());
